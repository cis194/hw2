...
-}
safeHead :: [a] -> Maybe a
safeHead list = undefined

safeTail :: [a] -> Maybe [a]
safeTail list = undefined
...
intListFilter predicate list = undefined
...
hanoi disks fromPeg toPeg storagePeg = undefined
